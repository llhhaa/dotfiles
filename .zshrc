...
export PATH="$PATH:$HOME/repos/k8s_tools/bin"
...
alias devkickstart='AWS_PROFILE=ci-dev-echo aws ec2 start-instances --instance-ids  i-01d3df7ad616df4b0'
...
# function kshell () {
#   ContType=$($2 | rg -oP ".*(?=(-[^a-z][a-z0-9]*){2})")
#   kubectl -n $1 -c "$ContType" exec -it $2 -- /bin/bash
# }
